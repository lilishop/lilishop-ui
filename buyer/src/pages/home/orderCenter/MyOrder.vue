      ...
      >
        ...
        <div class="order-body">
          ...
          <div>
            ...
            <Button @click="goPay(order.tradeSn)" size="small" type="success" v-if="order.allowOperationVO.pay">去支付</Button>
...
export default {
  ...
  methods: {
    ...
    goPay (sn) { // 去支付
      this.$router.push({path: '/payment', query: {orderType: 'TRADE', sn}});
    },
