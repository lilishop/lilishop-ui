  ...
  <div>
        ...
        <TabPane label="TA的余额" name="wallet">
          ...
          >
            ...
            <div style="min-width: 120px">
              ...
              <div class="points-top-text">
                {{
                  memberWalletInfo.memberFrozenWallet
                    ? memberWalletInfo.memberFrozenWallet
                    : 0 | unitPrice("￥")
                }}
              </div>
    ...
    >
      ...
      <div slot="footer">
        ...
        <Button type="primary" :loading="submitLoading" @click="addressSubmit"
          >保存</Button
        >
      </div>
    </Modal>
...
export default {
  ...
  methods: {
    ...
    getAddressData() {
      this.loading = true;
      API_Member.getMemberAddressData(this.id, this.addressSearchForm).then(
        (res) => {
          this.loading = false;
          if (res.success) {
