<template>
  <div>
    <Card>
      <Button class="mb_10" v-if="supplierForm.storeDisable === 'APPLYING'" type="primary" @click="auditHandler">审核</Button>
          ...
          <TabPane label="基本信息" class="tab" name="base">
            ...
            <div>
              <FormItem label="账号" prop="username">
                <Input v-model="supplierForm.username" clearable style="width: 350px" />
              </FormItem>

              <FormItem label="密码" prop="password">
                <Input v-model="supplierForm.password" type="password" clearable style="width: 350px" />
              </FormItem>

              <FormItem label="供应商名称" prop="storeName">
                <Input v-model="supplierForm.storeName" clearable style="width: 350px" />
              </FormItem>

              <FormItem label="库存预警数量" prop="stockWarning">
                <Input v-model="supplierForm.stockWarning" clearable style="width: 350px" />
              </FormItem>

              <FormItem label="供应商定位" prop="shopCenter">
                <!-- <Input v-model="supplierForm.storeCenter" @on-focus="$refs.liliMap.showMap = true" clearable style="width: 350px" /> -->
                <Button
                  type="info"
                  v-if="!supplierForm.storeCenter"
              ...
              <FormItem label="供应商所在地" prop="storeAddressPath">
                <Input
                  disabled
                  v-model="supplierForm.storeAddressPath"
                  style="width: 350px"
                />
              </FormItem>
              <FormItem label="供应商详细地址" prop="storeAddressDetail">
                <Input
                  v-model="supplierForm.storeAddressDetail"
                  clearable
                  style="width: 350px"
                />
              </FormItem>

              <FormItem label="供应商logo" class="storeLogo">
                <Avatar
                  style="height: 100px; width: 100px"
                  v-if="supplierForm.storeLogo"
                  shape="square"
                  icon="ios-person"
                  size="default"
                  :src="supplierForm.storeLogo"
                />
                <div>
              ...
              <FormItem label="供应商简介" prop="storeDesc" style="width: 350px">
                <Input
                  v-model="supplierForm.storeDesc"
                  type="textarea"
                  :rows="4"
                  maxlength="200"
                  show-word-limit
              ...
              <FormItem label="收件人姓名" prop="salesConsigneeName">
                <Input
                  v-model="supplierForm.salesConsigneeName"
                  clearable
                  style="width: 350px"
                />
              </FormItem>
              <FormItem label="收件人手机" prop="salesConsigneeMobile">
                <Input
                  v-model="supplierForm.salesConsigneeMobile"
                  clearable
                  maxlength="11"
                  style="width: 350px"
                />
              ...
              <FormItem label="详细地址" prop="salesConsigneeDetail">
                <Input
                  v-model="supplierForm.salesConsigneeDetail"
                  clearable
                  style="width: 350px"
                />
              </FormItem>
          ...
          <TabPane label="入驻信息" class="tab" name="entry">
            ...
            <div>
              <FormItem label="公司名称" prop="companyName">
                <Input v-model="supplierForm.companyName" clearable style="width: 350px" />
              </FormItem>

              <FormItem label="公司电话" prop="companyPhone">
                <Input v-model="supplierForm.companyPhone" clearable style="width: 350px" />
              </FormItem>
              ...
              <FormItem label="公司详细地址" prop="companyAddress">
                <Input v-model="supplierForm.companyAddress" clearable style="width: 350px" />
              </FormItem>
              <FormItem label="员工总数" prop="employeeNum">
                <InputNumber
                  ...
                  :min="1"
                  :max="9999999"
                  v-model="supplierForm.employeeNum"
                >
                </InputNumber>
              </FormItem>
              <FormItem label="注册资金" prop="registeredCapital">
                <InputNumber
                  ...
                  :min="1"
                  :max="9999999"
                  v-model="supplierForm.registeredCapital"
                >
                </InputNumber>
                <span style="margin-left: 10px">万</span>
              </FormItem>
              <FormItem label="联系人姓名" prop="linkName">
                <Input v-model="supplierForm.linkName" clearable style="width: 200px" />
              </FormItem>
              <FormItem label="联系人手机" prop="linkPhone">
                <Input
                  v-model="supplierForm.linkPhone"
                  maxlength="11"
                  clearable
                  style="width: 200px"
                />
              ...
              <FormItem label="电子邮箱" prop="companyEmail">
                <Input v-model="supplierForm.companyEmail" clearable style="width: 200px" />
              </FormItem>

              <Divider orientation="left">营业执照信息</Divider>

              <FormItem label="营业执照号" prop="licenseNum">
                <Input v-model="supplierForm.licenseNum" clearable style="width: 200px" />
              </FormItem>

              <FormItem label="法定经营范围" prop="scope">
                <Input v-model="supplierForm.scope" clearable style="width: 200px" />
              </FormItem>

              <Divider orientation="left">法人信息</Divider>

              <FormItem label="法人姓名" prop="legalName">
                <Input v-model="supplierForm.legalName" clearable style="width: 200px" />
              </FormItem>
              <FormItem label="法人证件号" prop="legalId">
                <Input v-model="supplierForm.legalId" clearable style="width: 200px" />
              </FormItem>
              ...
              <FormItem label="银行开户名" prop="settlementBankAccountName">
                <Input
                  v-model="supplierForm.settlementBankAccountName"
                  clearable
                  style="width: 200px"
                />
              </FormItem>
              <FormItem label="银行账号" prop="settlementBankAccountNum">
                <Input
                  v-model="supplierForm.settlementBankAccountNum"
                  clearable
                  style="width: 200px"
                />
              </FormItem>
              <FormItem label="银行支行名称" prop="settlementBankBranchName">
                <Input
                  v-model="supplierForm.settlementBankBranchName"
                  clearable
                  style="width: 200px"
                />
              </FormItem>
              <FormItem label="支行联行号" prop="settlementBankJointName">
                <Input
                  v-model="supplierForm.settlementBankJointName"
                  clearable
                  style="width: 200px"
                />
              </FormItem>
              ...
              <FormItem label="许可证电子版">
                <Avatar
                  style="height: 100px; width: 100px"
                  v-if="supplierForm.licencePhoto"
                  shape="square"
                  icon="ios-person"
                  size="default"
                  :src="supplierForm.licencePhoto"
                />
                <div>
      ...
      <div align="center">
        <Button
          ...
          >上一步</Button
        >
        <Button type="primary" v-show="tabNameList.indexOf(tabName) < 3" @click="next"
          >下一步</Button
        >
        <Button
          type="primary"
          v-show="tabNameList.indexOf(tabName) === 3"
          @click="save"
          v-if="!isRead"
        >
          {{ supplierId ? "修改" : "保存" }}
...
import { supplierDetail, supplierAdd, supplierEdit, supplierAudit } from "@/api/supplier";
...
export default {
  ...
  data() {
    return {
      ...
      isRead: false, // 是否只读，只有在供应商通过审核才可修改
      ...
      supplierValidate: {
        ...
        storeName: [{ required: true, message: "供应商名称不能为空" }],
        stockWarning:[{ required: true, message: "库存预警数量不能为空" }],
        companyAddress: [{ required: true, message: "公司地址不能为空" }],
        storeAddressDetail: [{ required: true, message: "供应商详细地址不能为空" }],
        storeDesc: [{ required: true, message: "供应商简介不能为空" }],
        salesConsigneeName: [{ required: true, message: "收件人姓名不能为空" }],
        salesConsigneeMobile: [{ required: true, message: "收件人手机不能为空" },
          {
            type: "string",
        ...
        salesConsigneeAddressPath: [{ required: true, message: "请选择售后地址" }],
        salesConsigneeDetail: [{ required: true, message: "售后地址详情不能为空" }],
        storeCenter: [{ required: true, message: "供应商未定位" }],
  ...
  methods: {
    ...
    // 选择公司地址
    selectedRegion(val) {
      this.$set(this.supplierForm, "companyAddressIdPath", val[0].toString());
      this.$set(
        this.supplierForm,
        "companyAddressPath",
    ...
    selectedConsigneeRegion(val) {
      this.$set(this.supplierForm, "salesConsigneeAddressId", val[0].toString());
      this.$set(
        this.supplierForm,
    ...
    callbackSelected(val) {
      ...
      if (this.picIndex === 0 || this.picIndex === 1) {
        this.supplierForm[this.selectedFormBtnName][this.picIndex] = val.url;
      } else {
        this.supplierForm[this.selectedFormBtnName] = val.url;
      }
      this.picIndex = "";
    },
    // 初始化数据
    ...
    // 获取供应商详情
    getSupplierDetail() {
      supplierDetail(this.supplierId).then((res) => {
        if (res.success) {
          this.infoResult = res.result;
          this.supplierForm = res.result;
          this.supplierForm.selfOperated
            ? (this.supplierForm.selfOperated = "true")
            : (this.supplierForm.selfOperated = "false");

          this.checkAllGroup = this.supplierForm.goodsManagementCategory.split(",");
          if (this.supplierForm.settlementCycle) {
            this.settlementCycle = this.supplierForm.settlementCycle.split(",");
          }
          this.supplierForm.legalPhoto = this.supplierForm.legalPhoto.split(",");

          this.address = this.supplierForm.companyAddressIdPath;
          this.returnAddress = this.supplierForm.salesConsigneeAddressId;
        }
      });
    },
    // 保存
    save() {
      this.$refs.supplierForm.validate((valid) => {
        ...
        if (this.checkAllGroup === "") {
          this.$Message.error("请选择供应商经营类目");
          this.tabName = "category";
          return;
        }
        if (valid) {

          const params = JSON.parse(JSON.stringify(this.supplierForm));
          if(params.password){
          ...
          if (this.supplierId) {
            ...
            supplierEdit(this.supplierId, params).then((res) => {
              if (res.success) {
            ...
            const params = JSON.parse(JSON.stringify(this.supplierForm));
            if(supplierForm.password){
              supplierForm.password = md5(supplierForm.password);
            }
            supplierAdd(params).then((resp) => {
              if (resp.success) {
    ...
    // 点击定位获取供应商地址
    getAddress(item) {
      this.supplierForm.storeCenter = item.position.lng + "," + item.position.lat;
      this.$set(this.supplierForm, "storeAddressPath", item.addr);
      this.$set(this.supplierForm, "storeAddressIdPath", item.addrId);
    },
    // 全部选中
    handleCheckAll() {
